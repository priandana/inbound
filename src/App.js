...
export default function App() {
  ...
  // ══════════════════════════════════════════════
  return (
    <div className="min-h-screen flex justify-center" style={{ background: '#f0f2f5' }}>
      <div className="w-full max-w-md bg-gray-50 relative flex flex-col" style={{ minHeight: '100dvh' }}>
        ...
        {/* ── SCROLL CONTENT ── */}
        <div className="flex-1 overflow-y-auto custom-scrollbar px-4 pt-3 pb-32">
        ...
        {/* ── BOTTOM NAVIGATION (GoPay Style) ── */}
        <div className="absolute bottom-0 left-0 right-0 z-40">
          <div className="mx-3 mb-4 bg-white rounded-3xl shadow-2xl border border-gray-100 px-2 py-2">
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {activeTab === 'form' ? 'Form Input' : 'Input'}
              </button>
              ...
              >
                ...
                {activeTab === 'history' ? 'Riwayat' : 'Riwayat'}
              </button>
