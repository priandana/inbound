      ...
      <div className="w-full max-w-md bg-gray-50 md:rounded-[40px] shadow-2xl overflow-hidden relative h-screen md:h-[800px] flex flex-col">
        ...
        <div className="bg-gradient-to-b from-red-600 to-red-700 px-6 pt-10 pb-6 rounded-b-[30px] shadow-sm relative z-20 flex-shrink-0">
          <div className="flex justify-between items-center">
            <div>
              <p className="text-red-200 text-[10px] font-bold tracking-wider mb-1 flex items-center gap-1 uppercase">
            ...
            <button onClick={() => setShowLogoutConfirm(true)} className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white hover:bg-white/30 transition shadow-sm border border-white/10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-white rounded-[24px] p-5 shadow-sm border border-red-50 relative z-20 overflow-visible">
                <div className="flex items-center gap-2 mb-4 relative z-10">
                  ...
                  <h3 className="font-bold text-gray-800 text-sm">Detail Barang</h3>
                </div>
              ...
              <div className="bg-white rounded-[24px] p-5 shadow-sm border border-red-50 relative z-10">
                ...
                {mainPhoto ? (
                  <div className="relative rounded-xl overflow-hidden group">
                    ...
                    <button type="button" onClick={() => setMainPhoto(null)} className="absolute top-2 right-2 bg-red-500 text-white p-1.5 rounded-full shadow-lg opacity-90">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                    </button>
                  </div>
                ) : (
                  <button type="button" onClick={() => mainPhotoInputRef.current.click()} className="w-full h-24 border-2 border-dashed border-red-200 rounded-xl flex flex-col items-center justify-center text-red-400 hover:bg-red-50/50 transition">
                    <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path></svg>
                    <span className="text-xs font-bold">Ketuk untuk Foto</span>
                  </button>
                )}
              </div>
              ...
              <div className="bg-white rounded-[24px] p-5 shadow-sm border border-red-50 relative z-10">
                ...
                {defectPhoto ? (
                  <div className="relative rounded-xl overflow-hidden group">
                    ...
                    <button type="button" onClick={() => setDefectPhoto(null)} className="absolute top-2 right-2 bg-red-500 text-white p-1.5 rounded-full shadow-lg opacity-90">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                    </button>
                  </div>
                ) : (
                  <button type="button" onClick={() => defectPhotoInputRef.current.click()} className="w-full py-3 border border-dashed border-gray-300 rounded-xl flex items-center justify-center gap-2 text-gray-500 hover:bg-gray-50 transition text-xs font-medium">
              ...
              <button type="submit" disabled={isLoading} className="w-full bg-red-600 text-white font-black text-base py-4 rounded-2xl shadow-lg shadow-red-600/20 active:scale-[0.98] transition-transform disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center gap-2 relative z-10 mb-6">
                {isLoading ? (
                  ...
                  <><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg> Submit Data</>
                )}
              </button>
            </form>
          ) : (
            <div className="space-y-4">
              <div className="flex justify-between items-end mb-2 px-1">
                <div>
                  ...
                  <p className="text-gray-400 text-xs font-medium">20 Inbound terakhir</p>
                </div>
                <button onClick={fetchHistory} className="bg-red-50 text-red-600 px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm flex items-center gap-1 active:scale-95 transition-transform">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg> Refresh
                </button>
              </div>
              ...
              {isLoadingHistory ? (
                ...
                <div className="text-center py-10 text-gray-400 bg-white rounded-3xl border border-dashed border-gray-200">
                  <svg className="w-10 h-10 mx-auto mb-3 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                  <p className="text-sm">Belum ada data masuk.</p>
                </div>
              ) : (
                  ...
                  <div key={index} className="bg-white p-4 rounded-2xl shadow-sm border border-red-50 relative overflow-hidden group">
                    ...
                    {data.keterangan && (
                      <div className="mt-2.5 bg-yellow-50 border border-yellow-200 p-2.5 rounded-xl flex items-start gap-1.5">
                        ...
                        <p className="text-[11px] font-medium text-yellow-700 italic">"{data.keterangan}"</p>
                      </div>
                    )}
        ...
        <div className="absolute bottom-4 left-5 right-5 z-40">
          <div className="bg-white/95 backdrop-blur-xl p-1.5 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex border border-gray-100">
            <button onClick={() => setActiveTab('form')} className={`flex-1 py-2 flex flex-col items-center gap-0.5 rounded-xl font-bold text-[10px] transition-all ${activeTab === 'form' ? 'bg-red-50 text-red-600' : 'text-gray-400 hover:text-gray-600'}`}>
              <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
              Terima Barang
            </button>
          ...
          <div className="absolute inset-0 z-50 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center p-6 animate-fade-in">
            <div className="bg-white rounded-[30px] p-6 shadow-2xl w-full max-w-[320px] scale-100 transition-transform">
              <div className="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-7 h-7 text-red-600 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
              </div>
